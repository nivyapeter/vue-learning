<template>
  <div>
    ...
    <form class="bg-white mx-auto w-2/5 p-16 flex flex-col items-center rounded-2xl">
      ...
      <button class="w-[300px] h-[40px] bg-sky-400 text-white cursor-pointer">Add Restaurant</button>
    </form>
  </div>
</template>
